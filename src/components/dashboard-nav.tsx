...
const links = [
  { href: "/compose", label: "Kirjoita", icon: MailPlus, primary: true },
  { href: "/inbox", label: "Saapuneet", icon: Inbox, preloadMessages: true },
  { href: "/starred", label: "Tähdellä merkityt", icon: Star, preloadMessages: true },
  { href: "/snoozed", label: "Lykätty", icon: Clock, preloadMessages: true },
  { href: "/sent", label: "Lähetetyt", icon: Send, preloadMessages: true },
  { href: "/drafts", label: "Luonnokset", icon: FileText, preloadMessages: true },
  {
    href: "/archived",
    label: "Arkisto",
    icon: Archive,
  ...
  { href: "/spam", label: "Roskaposti", icon: ShieldAlert, preloadMessages: true },
  { href: "/trash", label: "Roskakori", icon: Trash2, preloadMessages: true },
];
        ...
        <div className="mt-2 flex h-8 items-center justify-between px-3">
          ...
          {selectedMailbox && (
            <Dialog open={folderDialogOpen} onOpenChange={setFolderDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Luo kansio</DialogTitle>
                  <DialogDescription>
                    Lisää kansio valittuun postilaatikkoon.
                  </DialogDescription>
                </DialogHeader>
                <form onSubmit={createFolder} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="folderName">Kansion nimi</Label>
                    <Input
                      id="folderName"
                      value={newFolderName}
                  ...
                  >
                    {addingFolder ? "Luodaan..." : "Luo kansio"}
                  </Button>
                </form>
              </DialogContent>
            </Dialog>
